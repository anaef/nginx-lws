...
static ngx_command_t lws_commands[] = {
	...
	{
		ngx_string("lws_memory_limit"),
		NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
		ngx_conf_set_size_slot,
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(lws_loc_config_t, memory_limit),
		NULL
	},
	{
		ngx_string("lws_lifecycles"),
		NGX_HTTP_SRV_CONF | NGX_HTTP_LOC_CONF | NGX_CONF_TAKE1,
		ngx_conf_set_num_slot,
		NGX_HTTP_LOC_CONF_OFFSET,
		offsetof(lws_loc_config_t, lifecycles),
		NULL
	},
	{
...
static char *lws_init_main_conf (ngx_conf_t *cf, void *conf) {
	...
	if (lmcf->stat_cache_cap) {
		...
		lws_table_set_brent(lmcf->stat_cache, 1);
